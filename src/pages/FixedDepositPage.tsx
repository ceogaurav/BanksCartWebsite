    ...
    <main className="bg-light-blue min-h-screen w-full font-inter">
      ...
      <section id="fd-hero" className="w-full min-h-[80vh] flex flex-col items-center justify-center bg-gradient-to-tr from-[#1E40AF] to-[#3B82F6] text-white relative overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col items-center gap-6 py-16">
          ...
          <div className="flex gap-4 mt-6">
            <button className="bg-gradient-to-r from-[#059669] to-[#10B981] text-white font-poppins text-lg px-8 py-3 rounded-xl font-bold shadow-lg transform transition hover:scale-105 hover:shadow-2xl animate-pulse">Calculate Your Returns</button>
            <button className="bg-white text-[#1E40AF] font-poppins text-lg px-8 py-3 rounded-xl font-bold shadow-lg border-2 border-[#1E40AF] hover:bg-blue-50 hover:scale-105 transition">Start Investing Today</button>
          </div>
          {/* Trust Indicators */}
      ...
      <section className="w-full flex flex-col md:flex-row justify-center items-start gap-8 bg-[#F0F9FF] py-8">
        <div className="w-full md:w-1/2 max-w-2xl mx-auto">
          <FDCalculator LiveChartsComponent={FDLiveCharts} />
        </div>
