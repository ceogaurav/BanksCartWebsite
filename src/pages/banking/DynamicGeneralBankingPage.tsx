...
const DynamicGeneralBankingPage: React.FC = () => {
  ...
  let currentSlug = subPath || 'accounts-payable';
  
  if (location.pathname.includes('account-to-account-money-transfer')) {
    currentSlug = 'account-to-account-money-transfer';
  } else if (location.pathname.includes('accounts-payable')) {
    currentSlug = 'accounts-payable';
  } else if (location.pathname.includes('adani-capital')) {
    currentSlug = 'adani-capital';
  } else if (location.pathname.includes('adani-housing-finance')) {
    currentSlug = 'adani-housing-finance';
  } else if (location.pathname.includes('adani-one-credit-cards')) {
    currentSlug = 'adani-one-credit-cards';
  } else if (location.pathname.includes('adani-one-signature-credit-card')) {
    currentSlug = 'adani-one-signature-credit-card';
  } else if (location.pathname.includes('add-on-card')) {
    currentSlug = 'add-on-card';
  } else if (location.pathname.includes('aditya-birla-amc-launches-aditya-birla-sun-life-psu-equity-fund')) {
    currentSlug = 'aditya-birla-amc-launches-aditya-birla-sun-life-psu-equity-fund';
  } else if (location.pathname.includes('aaykar-setu-income-tax-mobile-app')) {
    currentSlug = 'aaykar-setu-income-tax-mobile-app';
  }
