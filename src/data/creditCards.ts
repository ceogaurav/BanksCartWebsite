...
export const creditCards: CreditCard[] = [
    ...
    },
    {
        ...
        category: 'Premium',
        image: 'https://www.idfcfirst.bank.in/content/dam/idfcfirstbank/images/exit-intent/Wealth-Exit-Intent.png',
    ...
    },
    {
        ...
        provider: 'SBI Card',
        category: 'Fuel',
        image: 'https://www.sbicard.com/sbi-card-en/assets/media/images/personal/credit-cards/network-card-images/octane-eapply-front.png',
        badges: ['Fuel', 'Rewards'],
        rating: 4.5,
        features: [
