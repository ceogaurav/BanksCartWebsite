...
/**
 * @param {object} props
 * @param {(loanType?: string) => void} [props.openApplyModal]
 */
    ...
    <div className="my-8">
      {openApplyModal && (
        <ApplyButton
          ...
          variant="primary"
          size="lg"
          className="bg-white text-blue-700 px-10 py-4 rounded-full font-bold text-lg shadow-lg hover:bg-blue-50 transition-all transform hover:scale-105 animate-bounce-in"
        >
